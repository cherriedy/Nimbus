...
public class SettingPreferencesImplTest {
    private SharedPreferences mockSharedPreferences;
    private SharedPreferences.Editor mockEditor;
    private SettingPreferencesImpl unitUserPreferencesManager;
    ...
    public void setUp() {
        ...
        unitUserPreferencesManager = new SettingPreferencesImpl(mockContext);
    }

    @Test
    public void setUnit_valid_key_unit() {
        unitUserPreferencesManager.setUnit(SettingPreferencesImpl.TEMPERATURE_UNIT, TemperatureUnit.CELSIUS);
        ...
        verify(mockEditor)
                .putString(SettingPreferencesImpl.TEMPERATURE_UNIT, TemperatureUnit.CELSIUS.name());
    ...
    public void setUnit_null_unit() {
        unitUserPreferencesManager.setUnit(SettingPreferencesImpl.PRESSURE_UNIT, null);
    }
    ...
    public void getUnit_valid_key_enum_default() {
        when(mockSharedPreferences.getString(
                        SettingPreferencesImpl.TEMPERATURE_UNIT, TemperatureUnit.CELSIUS.name()))
                .thenReturn(TemperatureUnit.FAHRENHEIT.name());

        Enum result = unitUserPreferencesManager.getUnit(SettingPreferencesImpl.TEMPERATURE_UNIT);
    ...
    public void getUnit_setUnit_consistency() {
        ...
        unitUserPreferencesManager.setUnit(SettingPreferencesImpl.TEMPERATURE_UNIT, TemperatureUnit.KELVIN);
        Enum result = unitUserPreferencesManager.getUnit(SettingPreferencesImpl.TEMPERATURE_UNIT);
