 ...
 */
public class ForecastApiPreferencesImpl implements ForecastApiPreferences {
    /**
    ...
    public ForecastApiPreferencesImpl(Context context) {
    ...
    private void initApiKey() {
        setApiKey(ForecastProvider.TOMORROW_IO.name(), "jxlIW6sxnnCUFCAIiCYPgnuckubOdW5s");
    }
